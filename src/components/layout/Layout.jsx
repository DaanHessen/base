...
function Layout({ children }) {
  ...
  // Scroll to top when navigating to a new page using the scroll container
  useEffect(() => {
    const scrollToTop = () => {
  ...
  // Handle scroll events to set navbar background based on container scroll
  useEffect(() => {
    const container = layoutContentRef.current;
    if (!container) return;
    const handleScroll = () => {
      const scrollPosition = container.scrollTop;
      const scrolledState = scrollPosition > 10;
      setIsScrolled(scrolledState);
      document.querySelector('.fixed-nav')?.setAttribute('data-scrolled', scrolledState ? 'true' : 'false');
    };
            ...
            {`
              ...
              *::-webkit-scrollbar {
              ...
              @media (max-width: 767px) {
                ...
                /* Ensure main content has proper spacing and flexbox layout */
                main {
                  min-height: 0;
                  flex: 1 0 auto;
                  padding-bottom: 0;
                ...
                /* Ensure proper layout for all page containers */
                .reservation-page {
                  flex: 1 0 auto;
                  display: flex;
                  flex-direction: column;
                ...
                /* Fix reservation page specific layout */
