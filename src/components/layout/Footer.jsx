        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="flex flex-col space-y-4">
            <div className="flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3 text-gold flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="flex items-center">
              <FaEnvelope className="h-5 w-5 mr-3 text-gold flex-shrink-0" />
              <button 
                className="text-sm hover:text-gold transition-colors duration-200"
